...
GENERATED_HEADER = """\
# CODE GENERATED BY vlm_convert_pipeline.py — DO NOT EDIT
# Regenerate: cd kubeflow-pipelines/docling-vlm && python vlm_convert_pipeline.py
# Source: kubeflow-pipelines/docling-vlm/vlm_convert_pipeline.py
"""
