...
def convert_pipeline_test(
    ...
    """
    Test pipeline for standard conversion with configurable parameters.

    This pipeline is designed for testing various configuration combinations
    and validating parameter handling.
    """
