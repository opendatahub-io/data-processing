...
GENERATED_HEADER = """\
# CODE GENERATED BY standard_convert_pipeline.py — DO NOT EDIT
# Regenerate: cd kubeflow-pipelines/docling-standard && python standard_convert_pipeline.py
# Source: kubeflow-pipelines/docling-standard/standard_convert_pipeline.py
"""
...
if __name__ == "__main__":
    ...
    # Prepend generated-code header to compiled YAML
    compiled = Path(output_yaml)
    original_content = compiled.read_text()
    compiled.write_text(GENERATED_HEADER + original_content)
